...
def generate_launch_description():
    ...
    # Declare name argument to apply a namespace
    name = LaunchConfiguration('name', default='')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'name',
            default_value='',
            description='Namespace or name to be applied to the nodes'),

        # Include state publisher launch file with namespace
        ...
        Node(
            ...
            output='screen',
            namespace=name,  # Apply namespace dynamically
        ),
    ])
