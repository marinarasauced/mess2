...
{
class UGVCalibrationClient : public rclcpp::Node
{
public:
    explicit UGVCalibrationClient(const rclcpp::NodeOptions & options = rclcpp::NodeOptions())
    : Node("ugv_calibration_client", options)
    {
        ...
        this->_calibration_timer = this->create_wall_timer(std::chrono::milliseconds(500), std::bind(&UGVCalibrationClient::send_goal, this)
        );
    ...
    void send_goal()
    {
        ...
        std::bind(&UGVCalibrationClient::_goal_response_callback, this, _1);
        
        send_goal_options.feedback_callback =
        std::bind(&UGVCalibrationClient::_feedback_callback, this, _1, _2);
        
        send_goal_options.result_callback =
        std::bind(&UGVCalibrationClient::_result_callback, this, _1);
...
RCLCPP_COMPONENTS_REGISTER_NODE(mess2_actions::UGVCalibrationClient)
